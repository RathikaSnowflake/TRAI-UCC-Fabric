...
exports.invokeSDK = function (par_contract, jsonblob,reply) {
     
console.log("Contract Received: "+ par_contract);
    
var contractname = par_contract;
var json_data = JSON.stringify(jsonblob);
blockjson = json_data;
console.log("JSON data received:"+ json_data);
        var options = {
