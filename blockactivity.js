...
exports.queryblockSDK = function (fnName,par_txnId,reply,blockjson) {
   ...
   // .find(rwset => rwset.namespace === 'trai');
	...
	var db_list = {type:"INVOKE",txn_id: txnid,chaincode_id : "trai",payload: payload,version : version,bc_timestamp : timestamp,txn_type : txn_type, deployments: "0" ,invocations:"1",block_id:blockNumber }
